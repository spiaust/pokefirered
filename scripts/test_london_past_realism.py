"""Walk historical London landmarks while preserving historical progression."""
...
DATA={'LondonPast':(37,0,[(45,25,'palace'),(37,20,'square'),(55,15,'westminster-bridge'),(58,32,'lambeth-bridge'),(61,24,'east-bank')],[(48,26,'UP'),(38,18,'LEFT'),(60,13,'DOWN'),(62,35,'UP')])}
...
def run(city):
 ...
 try:
  load_checkpoint(e,'london-past-arrival',True);checkmap(e);before=preserved(e)[1:];story=tuple(e.var(v) for v in range(0x40d5,0x40ef))
 ...
 try:
  ...
  from test_london_past import leave,clerk
  leave(e);clerk(e);checkmap(e)
  from test_time import cross
  cross(e);assert e.location()==(43,17,15,24)
  print(f'PASS: {city} district Save/cold Continue, era map, Southampton round trip and Celebi return',flush=True)
 finally:e.close()
